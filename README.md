...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Baseline Final Sprint** 🔄 | XCSP3-2025-CSP25 | `defc217a — Merge remote-tracking branch 'origin/xcsp3_26' into xcsp3_26` | 2026-06-04 17:47:37 | — | 44/102 |
...
|--------|-------|--------|----------|---------|---------|
| `gurobi` | XCSP3-2025-CSP25 | 🔄 running | 149/200 | 2026-06-04 17:48:24 | 20m 13s |
...
| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `exact` | XCSP3-2025-CSP25 | 🔄 running | 117/200 | 2026-06-03 14:03:02 | 28h 05m |
