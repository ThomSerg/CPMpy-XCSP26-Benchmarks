...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **NoOverlap via Cumulative linear decomp** 🔄 | XCSP3-2025-CSP25 | `24917c34 — Test: linear decomp nooverlap via cumulative` | 2026-05-29 10:57:41 | — | 39/145 |
...
|--------|-------|--------|----------|---------|---------|
| `gurobi` | XCSP3-2025-CSP25 | 🔄 running | 156/200 | 2026-05-29 10:58:07 | 20m 07s |
