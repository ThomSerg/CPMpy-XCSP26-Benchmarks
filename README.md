...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Positive globals** 🔄 | XCSP3-2025-CSP25 | `12444731 — Merge remote-tracking branch 'origin/positive_globals' into xcsp3_26` | 2026-06-03 10:16:38 | — | 22/95 |
...
|--------|-------|--------|----------|---------|---------|
| `pindakaas` | XCSP3-2025-CSP25 | 🔄 running | 95/200 | 2026-06-03 10:17:16 | 18m 56s |
...
|--------|-----|-------|---------|---------|-------|
| `pindakaas` | 12 | 10 | 12 | 61 | 95 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `pindakaas` | 47 | 0 | 48 | 95 |
