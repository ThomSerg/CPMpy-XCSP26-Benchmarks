...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **NoOverlap via Cumulative linear decomp** 🔄 | XCSP3-2025-CSP25 | `24917c34 — Test: linear decomp nooverlap via cumulative` | 2026-05-29 10:57:41 | — | 12/24 |
...
|--------|-------|--------|----------|---------|---------|
| `gurobi` | XCSP3-2025-CSP25 | 🔄 running | 24/200 | 2026-05-29 10:58:07 | 2m 17s |
