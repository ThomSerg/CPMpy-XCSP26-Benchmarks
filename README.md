...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Simplify bool** 🔄 | XCSP3-2025-CSP25 | `36447b7f — remove trailing comma` | 2026-06-01 15:53:46 | — | 59/145 |
...
_Tracks: XCSP3-2025-CSP25 · cpmpy: `36447b7f — remove trailing comma` · Created: 2026-06-01 15:53:46 · Last run: —_

### Live Progress

| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `gurobi` | XCSP3-2025-CSP25 | 🔄 running | 145/200 | 2026-06-01 15:54:14 | 23m 07s |
