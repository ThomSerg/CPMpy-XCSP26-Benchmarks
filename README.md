...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Rsync fix** 🔄 | XCSP3-2025-CSP25 | `6e486806 — Merge remote-tracking branch 'origin/save_reification_to_csemap' into xcsp3_26` | 2026-06-05 07:28:44 | — | 110/157 |
...
|--------|-------|--------|----------|---------|---------|
| `ortools` | XCSP3-2025-CSP25 | 🔄 running | 158/200 | 2026-06-05 07:29:24 | 19m 44s |
...
|--------|-----|-------|---------|-----|-------|---------|-------|
| `ortools` | 86 | 24 | 1 | **11** | 0 | 36 | 158 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `ortools` | 146 | 0 | 12 | 158 |
...
| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `exact` | XCSP3-2025-CSP25 | 🔄 running | 117/200 | 2026-06-03 14:03:02 | 41h 46m |
