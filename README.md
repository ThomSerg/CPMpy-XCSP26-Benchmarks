...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Ablation - Disable Regular in linearize** 🔄 | XCSP3-2025-CSP25 | `2ab26260 — Revert based on ablation` | 2026-06-03 22:57:17 | — | 15/31 |
...
|--------|-------|--------|----------|---------|---------|
| `pindakaas` | XCSP3-2025-CSP25 | 🔄 running | 32/200 | 2026-06-03 22:57:59 | 8m 03s |
...
| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `exact` | XCSP3-2025-CSP25 | 🔄 running | 117/200 | 2026-06-03 14:03:02 | 9h 03m |
