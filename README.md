...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Disable regular linearise** 🔄 | XCSP3-2025-CSP25 | `0e7b2159 — Fix xglobals import` | 2026-06-05 12:34:06 | — | 47/183 |
...
_Tracks: XCSP3-2025-CSP25 · cpmpy: `0e7b2159 — Fix xglobals import` · Created: 2026-06-05 12:34:06 · Last run: —_

### Live Progress

| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `pindakaas` | XCSP3-2025-CSP25 | 🔄 running | 184/200 | 2026-06-05 12:34:57 | 29m 28s |
...
|--------|-----|-------|---------|-----|-------|---------|-------|
| `pindakaas` | 31 | 16 | 19 | **69** | 0 | 49 | 184 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `pindakaas` | 100 | 0 | 84 | 184 |
...
| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `exact` | XCSP3-2025-CSP25 | 🔄 running | 117/200 | 2026-06-03 14:03:02 | 47h 01m |
