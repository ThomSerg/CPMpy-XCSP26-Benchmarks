...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **NoOverlap via Cumulative linear decomp** 🔄 | XCSP3-2025-CSP25 | `24917c34 — Test: linear decomp nooverlap via cumulative` | 2026-05-29 10:57:41 | — | 39/180 |
...
_Tracks: XCSP3-2025-CSP25 · cpmpy: `24917c34 — Test: linear decomp nooverlap via cumulative` · Created: 2026-05-29 10:57:41 · Last run: —_

### Live Progress

| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `gurobi` | XCSP3-2025-CSP25 | 🔄 running | 181/200 | 2026-05-29 10:58:07 | 23m 06s |
