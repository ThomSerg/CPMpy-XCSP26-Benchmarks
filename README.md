...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Order encoding for inequalities - long** 🔄 | XCSP3-2025-CSP25 | `e3f20354 — Test: Force cumulative time for linear decompose` | 2026-05-31 22:29:41 | — | 104/169 |
...
|--------|-------|--------|----------|---------|---------|
| `ortools` | XCSP3-2025-CSP25 | 🔄 running | 169/200 | 2026-05-31 22:30:09 | 52m 55s |
...
|--------|-----|-------|---------|---------|-------|
| `ortools` | 78 | 26 | 1 | 64 | 169 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `ortools` | 143 | 0 | 26 | 169 |
