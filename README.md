...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Per-table type linear decompose** 🔄 | XCSP3-2025-CSP25 | `d6eff956 — Per-table type  linear decompose` | 2026-06-01 10:29:03 | — | 48/92 |
...
|--------|-------|--------|----------|---------|---------|
| `gurobi` | XCSP3-2025-CSP25 | 🔄 running | 92/200 | 2026-06-01 10:29:36 | 16m 50s |
