...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Stronger GCC decomp** 🔄 | XCSP3-2025-CSP25 | `2023f924 — Merge remote-tracking branch 'origin/stronger_gcc_decomp' into xcsp3_26` | 2026-06-03 00:12:37 | — | 39/177 |
...
|--------|-------|--------|----------|---------|---------|
| `pindakaas` | XCSP3-2025-CSP25 | 🔄 running | 178/200 | 2026-06-03 00:14:00 | 29m 39s |
...
|--------|-----|-------|---------|---------|-------|
| `pindakaas` | 26 | 13 | 15 | 124 | 178 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `pindakaas` | 93 | 0 | 85 | 178 |
