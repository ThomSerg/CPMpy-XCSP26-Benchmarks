...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Ablation - Positive ShortTable** 🔄 | XCSP3-2025-CSP25 | `8080fcba — Remove duplicate solution row selecting var` | 2026-06-03 20:29:41 | — | 29/121 |
...
|--------|-------|--------|----------|---------|---------|
| `pindakaas` | XCSP3-2025-CSP25 | 🔄 running | 121/200 | 2026-06-03 20:30:21 | 21m 00s |
...
|--------|-----|-------|---------|-----|-------|---------|-------|
| `pindakaas` | 17 | 12 | 16 | **41** | 0 | 35 | 121 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `pindakaas` | 66 | 0 | 55 | 121 |
...
| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `exact` | XCSP3-2025-CSP25 | 🔄 running | 117/200 | 2026-06-03 14:03:02 | 6h 48m |
