...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Rsync fix** 🔄 | XCSP3-2025-CSP25 | `6e486806 — Merge remote-tracking branch 'origin/save_reification_to_csemap' into xcsp3_26` | 2026-06-05 07:28:44 | — | 114/179 |
...
_Tracks: XCSP3-2025-CSP25 · cpmpy: `6e486806 — Merge remote-tracking branch 'origin/save_reification_to_csemap' into xcsp3_26` · Created: 2026-06-05 07:28:44 · Last run: —_

### Live Progress

| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `ortools` | XCSP3-2025-CSP25 | 🔄 running | 179/200 | 2026-06-05 07:29:24 | 24m 02s |
...
|--------|-----|-------|---------|-----|-------|---------|-------|
| `ortools` | 87 | 27 | 2 | **11** | 0 | 52 | 179 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `ortools` | 167 | 0 | 12 | 179 |
...
| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `exact` | XCSP3-2025-CSP25 | 🔄 running | 117/200 | 2026-06-03 14:03:02 | 41h 50m |
