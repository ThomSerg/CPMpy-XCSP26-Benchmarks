...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Per-table type linear decompose** 🔄 | XCSP3-2025-CSP25 | `d6eff956 — Per-table type  linear decompose` | 2026-06-01 10:29:03 | — | 49/151 |
...
|--------|-------|--------|----------|---------|---------|
| `gurobi` | XCSP3-2025-CSP25 | 🔄 running | 162/200 | 2026-06-01 10:29:36 | 30m 07s |
