...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Order encoding for inequalities - long** 🔄 | XCSP3-2025-CSP25 | `e3f20354 — Test: Force cumulative time for linear decompose` | 2026-05-31 22:29:41 | — | 99/150 |
...
|--------|-------|--------|----------|---------|---------|
| `ortools` | XCSP3-2025-CSP25 | 🔄 running | 150/200 | 2026-05-31 22:30:09 | 36m 54s |
...
|--------|-----|-------|---------|---------|-------|
| `ortools` | 75 | 24 | 0 | 51 | 150 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `ortools` | 124 | 0 | 26 | 150 |
