...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Per-table type linear decompose** 🔄 | XCSP3-2025-CSP25 | `d6eff956 — Per-table type  linear decompose` | 2026-06-01 10:29:03 | — | 49/187 |
...
_Tracks: XCSP3-2025-CSP25 · cpmpy: `d6eff956 — Per-table type  linear decompose` · Created: 2026-06-01 10:29:03 · Last run: —_

### Live Progress

| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `gurobi` | XCSP3-2025-CSP25 | 🔄 running | 189/200 | 2026-06-01 10:29:36 | 37m 27s |
