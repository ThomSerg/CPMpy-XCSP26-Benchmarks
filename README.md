...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Stronger GCC decomp** 🔄 | XCSP3-2025-CSP25 | `2023f924 — Merge remote-tracking branch 'origin/stronger_gcc_decomp' into xcsp3_26` | 2026-06-03 00:12:37 | — | 39/187 |
...
_Tracks: XCSP3-2025-CSP25 · cpmpy: `2023f924 — Merge remote-tracking branch 'origin/stronger_gcc_decomp' into xcsp3_26` · Created: 2026-06-03 00:12:37 · Last run: —_

### Live Progress

| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `pindakaas` | XCSP3-2025-CSP25 | 🔄 running | 187/200 | 2026-06-03 00:14:00 | 32m 22s |
...
|--------|-----|-------|---------|---------|-------|
| `pindakaas` | 26 | 13 | 21 | 127 | 187 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `pindakaas` | 98 | 0 | 89 | 187 |
