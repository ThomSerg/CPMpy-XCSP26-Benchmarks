...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Order encoding for inequalities - long** 🔄 | XCSP3-2025-CSP25 | `e3f20354 — Test: Force cumulative time for linear decompose` | 2026-05-31 22:29:41 | — | 102/164 |
...
_Tracks: XCSP3-2025-CSP25 · cpmpy: `e3f20354 — Test: Force cumulative time for linear decompose` · Created: 2026-05-31 22:29:41 · Last run: —_

### Live Progress

| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `ortools` | XCSP3-2025-CSP25 | 🔄 running | 164/200 | 2026-05-31 22:30:09 | 50m 14s |
...
|--------|-----|-------|---------|---------|-------|
| `ortools` | 76 | 26 | 0 | 62 | 164 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `ortools` | 138 | 0 | 26 | 164 |
