...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **linearize_reified_variables for OR-Tools** 🔄 | XCSP3-2025-COP25 | `—` | 2026-05-26 13:50:16 | — | 216/241 |
...
|--------|-------|--------|----------|---------|---------|
| `ortools` | XCSP3-2025-COP25 | 🔄 running | 241/250 | 2026-05-26 13:50:30 | 42m 37s |
...
|--------|-----|-------|---------|---------|-------|
| `ortools` | 194 | 22 | 2 | 23 | 241 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `ortools` | 220 | 0 | 21 | 241 |

---

## baseline

_Tracks: XCSP3-2025-COP25, XCSP3-2025-CSP25 · cpmpy: `45fc0181 — Deprecate old runner` · Created: 2026-05-21 16:23:19 · Last run: 2026-05-26 12:50:35_
