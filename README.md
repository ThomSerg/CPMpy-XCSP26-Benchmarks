...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Use new MDD global in xcsp3 parser** 🔄 | XCSP3-2025-CSP25 | `—` | 2026-05-27 09:08:46 | — | 87/132 |
...
_Tracks: XCSP3-2025-CSP25 · cpmpy: `—` · Created: 2026-05-27 09:08:46 · Last run: —_

### Live Progress

| Solver | Track | Status | Progress | Started | Elapsed |
|--------|-------|--------|----------|---------|---------|
| `ortools` | XCSP3-2025-CSP25 | 🔄 running | 132/200 | 2026-05-27 09:09:01 | 11m 25s |
...
|--------|-----|-------|---------|---------|-------|
| `ortools` | 65 | 22 | 0 | 45 | 132 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `ortools` | 109 | 0 | 23 | 132 |
