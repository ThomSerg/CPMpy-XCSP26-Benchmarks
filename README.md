...
|---|-----------|--------|--------------|---------|----------|--------|
| 1 | **Restore Regular** 🔄 | XCSP3-2025-CSP25 | `5c385788 — Restore competition regular` | 2026-06-03 13:26:22 | — | 33/172 |
...
|--------|-------|--------|----------|---------|---------|
| `pindakaas` | XCSP3-2025-CSP25 | 🔄 running | 172/200 | 2026-06-03 13:27:02 | 27m 45s |
...
|--------|-----|-------|---------|-----|-------|---------|-------|
| `pindakaas` | 21 | 12 | 26 | **59** | **14** | 40 | 172 |

#### Solution Checker

| Solver | Valid | Invalid | Skipped | Total |
|--------|-------|---------|---------|-------|
| `pindakaas` | 76 | 0 | 96 | 172 |
